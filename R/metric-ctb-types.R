...
#'
#' @noRd
rm_data_ctb_diversity_internal <- function (path, end_date = Sys.Date ()) {
...
rm_metric_ctb_diversity <- function (path, end_date = Sys.Date ()) {
    rm_data_ctb_diversity_internal (path, end_date)
}

rm_metric_ctb_diversity_url <- function () {
