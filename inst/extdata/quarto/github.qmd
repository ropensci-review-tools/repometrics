...
function getMaxValues(log) {
    ...
    console.log("------SORTED MAX VALUES = " + JSON.stringify(sortedMaxValues));
...
console.log("-----max values = " + JSON.stringify(maxValues));
console.log("-----unique contribs = " + uniqueCtbs);
console.log("-----Number of unique contribs = " + numUniqueCtbs);
```
