...
The "Force Strength" slider can be used to modify the strength of the forces
connecting the nodes of the graph. More negative values reduce the strength,
and expand the graph.
