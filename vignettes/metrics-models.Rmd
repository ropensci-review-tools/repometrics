...
vignette: >
  %\VignetteIndexEntry{Metrics models}
...
["models"](https://chaoss.community/kbtopic/all-metrics-models/) adapted from
those developed by the [CHAOSS community ("Community Health Analytics in Open
Source Software")](https://chaoss.community/). These models collate various
